...
public struct NavigatorStoringView<Content, Destination: PersistentDestination, TabItemTag: Codable & Hashable, SheetTag: Codable & Hashable, Storage: NavigatorStorage, S: Scheduler>: View where Content: View, Storage.Destination == Destination, Storage.TabItemTag == TabItemTag, Storage.SheetTag == SheetTag {
